...
ActiveRecord::Schema.define(version: 2020_11_04_162553) do
  ...
  create_table "places", force: :cascade do |t|
    ...
    t.index ["local", "coordinate"], name: "index_places_on_local_and_coordinate", unique: true
    t.index ["local"], name: "index_places_on_local"
  end
